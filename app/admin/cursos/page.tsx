...
import { ExcluirCursoButton } from "@/components/admin/excluir-curso-button";
...
export default async function AdminCursosPage() {
  ...
  return (
    <div>
      ...
      <div className="mt-6 overflow-hidden rounded-xl border border-[var(--color-line)] bg-[var(--color-paper)]">
          ...
          {cursos.map((curso) => (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <ExcluirCursoButton cursoId={curso.id} titulo={curso.titulo} />
              </div>
            </li>
          ))}
